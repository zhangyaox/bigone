...
public class AdminInterceptor extends HandlerInterceptorAdapter {//继承 HandlerInterceptorAdapter节省资源
	@Override
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if(null==session) {//如果没有session
			...
			User attribute = (User) session.getAttribute("admin");//依靠user键取我存入的对象
